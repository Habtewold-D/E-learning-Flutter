...
class TeacherRAGContentScreen extends ConsumerStatefulWidget {
  const TeacherRAGContentScreen({super.key});

  @override
  ConsumerState<TeacherRAGContentScreen> createState() => _TeacherRAGContentScreenState();
}

class _TeacherRAGContentScreenState extends ConsumerState<TeacherRAGContentScreen> {
